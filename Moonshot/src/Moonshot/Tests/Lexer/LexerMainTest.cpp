...
bool LexerMainTest::runTest(Context & context)
{
	...
	context.options.setAttr(OptionsList::LEX_logPushedTokens, ParameterValue(false));
	context.options.setAttr(OptionsList::LEX_logTotalTokenCount, ParameterValue(true));
