...
# append_sourcefile_to_list
#   appends the absolute paths of the source files to the variable.
macro(append_sourcefile_to_list variable_name)
...
# add_source
#   add the source files in arguments to a variable named after the  
...
macro(add_source)
  ...
  append_sourcefile_to_list(${the_var} ${ARGN})
  # propagate the variable in parent directories
  set(${the_var} ${${the_var}} PARENT_SCOPE)
endmacro()

# add source dir
#   adds the desired source directories to the given variable 
#   name.
